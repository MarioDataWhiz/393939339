...
const App = () => {
  ...
  const fetchStudIn = async () => {
    try {
      const [studentsRes, instructorsRes] = await Promise.all([
        axios.get('https://finalfinal3-ehfybybcagdccuhb.eastus-01.azurewebsites.net/students'),
        axios.get('https://finalfinal3-ehfybybcagdccuhb.eastus-01.azurewebsites.net/instructors')
      ]);
  ...
  const handleSaveStudent = async (id) => {
    try {
      await axios.put(`https://finalfinal3-ehfybybcagdccuhb.eastus-01.azurewebsites.net/students/${id}`, updatedStudent);
  ...
  const handleSaveInstructor = async (id) => {
    try {
      await axios.put(`https://finalfinal3-ehfybybcagdccuhb.eastus-01.azurewebsites.net/instructors/${id}`, updatedInstructor);
